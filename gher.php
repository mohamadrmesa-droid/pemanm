...
<body>
  ...
  <script>
    ...
    document.getElementById('shamelBtn').addEventListener('click', function() {
      window.location.href = userId ? `shamel.html?user_id=${userId}` : 'shamel.html';
    });

    const data = [
      { name:'شركة ولاء للتأمين', logo:'assets/logos/walaa.jpg', base:502, features:[
      ...
      { name:'الجزيرة تكافل', logo:'assets/logos/aljazira.webp', base:520, features:[
        {label:'المسؤولية المدنية تجاه الغير – حد أقصى 10,000,000', add:0, fixed:true}
      ]},
      { name:'الخليجية العامة للتأمين', logo:'assets/logos/khalejeah.webp', base:630, features:[
        {label:'المسؤولية المدنية تجاه الغير – حد أقصى 10,000,000', add:0, fixed:true},
        {label:'مساعدة على الطريق', add:25},
        {label:'تغطية الحوادث الشخصية للسائق', add:60},
        {label:'تغطية الحوادث الشخصية للركاب', add:290}
      ]},
      { name:'المتحدة للتأمين التعاوني', logo:'assets/logos/almotahida.png', base:650, features:[
        {label:'المسؤولية المدنية تجاه الغير – حد أقصى 10,000,000', add:0, fixed:true},
        {label:'المساعدة على الطريق', add:40},
        {label:'تغطية الحوادث الشخصية للسائق', add:150}
      ]},
      { name:'بروج للتأمين', logo:'assets/logos/borog.png', base:679, features:[
        {label:'المسؤولية المدنية تجاه الغير – حد أقصى 10,000,000', add:0, fixed:true},
        {label:'المساعدة على الطريق', add:70},
        {label:'تغطية الحوادث الشخصية للسائق', add:20}
      ]},
      { name:'شركة أمانة للتأمين', logo:'assets/logos/amana.jpg', base:705, features:[
        {label:'المسؤولية المدنية تجاه الغير – حد أقصى 10,000,000', add:0, fixed:true},
        {label:'إصابة السائق/حادث شخصي', add:50},
        {label:'المساعدة على الطريق الممتد', add:50}
      ]},
      { name:'التعاونية للتأمين', logo:'assets/logos/tawuniya.jpg', base:734, features:[
        {label:'المسؤولية المدنية تجاه الغير – حد أقصى 10,000,000', add:0, fixed:true},
        {label:'المساعدة على الطريق', add:50}
      ]},
      { name:'الشركة الوطنية للتأمين', logo:'assets/logos/alwatania.png', base:800, features:[
        {label:'المسؤولية المدنية تجاه الغير – حد أقصى 10,000,000', add:0, fixed:true}
      ]},
      { name:'ليفا للتأمين', logo:'assets/logos/liva.jpg', base:800, features:[
        {label:'المسؤولية المدنية تجاه الغير – حد أقصى 10,000,000', add:0, fixed:true},
        {label:'تغطية الحوادث الشخصية للسائق', add:280},
        {label:'المساعدة على الطريق', add:50}
      ]},
      { name:'شركة الدرع العربي', logo:'assets/logos/arabian.webp', base:800, features:[
        {label:'المسؤولية المدنية تجاه الغير – حد أقصى 10,000,000', add:0, fixed:true},
        {label:'مساعدة على الطريق', add:25},
        {label:'تغطية الحوادث الشخصية للسائق', add:60},
        {label:'تغطية الحوادث الشخصية للركاب', add:290}
      ]},
      { name:'سندة للتأمين', logo:'assets/logos/sanad.png', base:838, features:[
        {label:'المسؤولية المدنية تجاه الغير – حد أقصى 10,000,000', add:0, fixed:true},
        {label:'المساعدة على الطريق', add:40}
      ]},
      { name:'ميدغلف للتأمين', logo:'assets/logos/medgulf.png', base:838, features:[
        {label:'المسؤولية المدنية تجاه الغير – حد أقصى 10,000,000', add:0, fixed:true},
        {label:'تغطية الحوادث الشخصية للسائق', add:55}
      ]},
      { name:'متكاملة للتأمين', logo:'assets/logos/motakamela.jpg', base:900, features:[
        {label:'المسؤولية المدنية تجاه الغير – حد أقصى 10,000,000', add:0, fixed:true},
        {label:'المساعدة على الطريق', add:30}
      ]},
      { name:'شركة الاتحاد للتأمين', logo:'assets/logos/aletihad.png', base:902, features:[
        {label:'المسؤولية المدنية تجاه الغير – حد أقصى 10,000,000', add:0, fixed:true},
        {label:'تغطية الحوادث الشخصية للسائق', add:50}
      ]},
      { name:'المجموعة المتحدة للتأمين التعاوني (UCA)', logo:'assets/logos/almotahida.png', base:977, features:[
        {label:'المسؤولية المدنية تجاه الغير – حد أقصى 10,000,000', add:0, fixed:true},
        {label:'المساعدة على الطريق', add:50},
        {label:'تغطية الحوادث الشخصية للسائق', add:240}
      ]},
      { name:'التأمين العربي التعاوني', logo:'assets/logos/arabia-coop.png', base:1020, features:[
        {label:'المسؤولية المدنية تجاه الغير – حد أقصى 10,000,000', add:0, fixed:true},
        {label:'تغطية الحوادث الشخصية للسائق', add:60}
      ]},
      { name:'تكافل الراجحي', logo:'assets/logos/takafol.jpg', base:1300, features:[
        {label:'المسؤولية المدنية تجاه الغير – حد أقصى 10,000,000', add:0, fixed:true},
      ...
      { name:'Allianz – أليانز', logo:'assets/logos/allianz.png', base:1400, features:[
        {label:'المسؤولية المدنية تجاه الغير – حد أقصى 10,000,000', add:0, fixed:true},
        {label:'تغطية الحوادث الشخصية للسائق فقط', add:60}
      ]},
      { name:'GIG – جي آي جي', logo:'assets/logos/gig.png', base:2000, features:[
        {label:'المسؤولية المدنية تجاه الغير – حد أقصى 10,000,000', add:0, fixed:true},
        {label:'المساعدة على الطريق', add:50},
